...
export default function BusdcAnalysisPage() {
  ...
  const { data: history, isLoading: historyLoading } = useQuery({
    queryKey: ['wallet-history', BUSDC_WALLET],
    queryFn: () => fetchWalletHistory(BUSDC_WALLET),
  });

  const { data: currentAssets } = useQuery({
    queryKey: ['wallet-current', BUSDC_WALLET],
    queryFn: () => fetchCurrentAssets(BUSDC_WALLET),
  });
