...
const PUMPSPACE_URL = `https://pumpspace.io/wallet/detail?account=${BTCB_XAUT_WALLET}`;
...
export default function BtcbXautAnalysisPage() {
  ...
  const { data: history, isLoading: historyLoading } = useQuery({
    queryKey: ['wallet-history', BTCB_XAUT_WALLET],
    queryFn: () => fetchWalletHistory(BTCB_XAUT_WALLET),
  });

  const { data: currentAssets } = useQuery({
    queryKey: ['wallet-current', BTCB_XAUT_WALLET],
    queryFn: () => fetchCurrentAssets(BTCB_XAUT_WALLET),
  });
