...
const WALLET_GROUPS: Record<string, string[]> = {
  '1': [
    '0x3654378aa2deb0860c2e5c7906471c8704c44c6f', // 바이백펀드 (메인)
  ...
  '4': [
    '0xDf3723f75a8B3E10Fe0093991C961d58A5549fDE', // 바이백펀드-1
    '0x8c29527976b07F6e9c5Fa7705a4997C3B9e7fdD4', // 바이백펀드-2
  ],
  '5': [
    '0xF7E18a70C31C5E8D89e00a5a5e81Fc44E607513B', // 바이백펀드-3
    '0x7c6d9059792C711229Ca7295eaa8916cF2a33776', // 바이백펀드-4
  ],
  '6': [
    '0x61CA700c0b004029Fc4A80C409C9829ABe79528D', // 바이백펀드-5
    '0xa617A017A09CFEc5d22598e92C252dfBF327fF91', // 바이백펀드-6
  ],
  '7': [
    '0x981086C666D3EB8A11f122B001B58346A6422B80', // 바이백펀드-7
    '0x5DEf16B5E663baEb75C44B30c273281aFD5Fd342', // 바이백펀드-8
  ],
};
