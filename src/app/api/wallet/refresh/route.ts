...
const WALLET_GROUPS: Record<string, string[]> = {
  ...
  '4': ['0xfd48a5FFE5127896E93BAA8074CE98c5a999Ea97'], // v3 수수료 펀드
  '5': ['0x000000000000000000000000000000000000dEaD'], // 소각 지갑
  '6': ['0x525e7f0a5d3fd6169d6ec35288104d52bf3bb95f'], // 팀 지갑
  '7': ['0xDf3723f75a8B3E10Fe0093991C961d58A5549fDE'], // 바이백 AI(1)
  '8': ['0x8c29527976b07F6e9c5Fa7705a4997C3B9e7fdD4'], // 바이백 AI(2)
  '9': ['0xF7E18a70C31C5E8D89e00a5a5e81Fc44E607513B'], // 바이백 AI(3)
  '10': ['0x7c6d9059792C711229Ca7295eaa8916cF2a33776'], // 바이백 AI(4)
  '11': ['0x61CA700c0b004029Fc4A80C409C9829ABe79528D'], // 바이백 AI(5)
  '12': ['0xa617A017A09CFEc5d22598e92C252dfBF327fF91'], // 바이백 AI(6)
  '13': ['0x981086C666D3EB8A11f122B001B58346A6422B80'], // 바이백 AI(7)
  '14': ['0x5DEf16B5E663baEb75C44B30c273281aFD5Fd342'], // 바이백 AI(8)
  '15': ['0xe2E6252aBf18680169f8e95aa8f2b5c5E6c05390'], // 아돌 AI(1)
  '16': ['0x8E63231be79fFDFECf46b13FFDE1881fD9C7e231'], // 아돌 AI(2)
  '17': ['0x9Bd2c37535F41cE4FC373cAcee1F7Bd023DC5b9A'], // 아돌 AI(3)
  '18': ['0xC81A059E9A2185A97925d6B7b5D527294c439625'], // 아돌 AI(4)
};
